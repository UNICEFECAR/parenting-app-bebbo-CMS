...
3. Download the database from Acquia server and import the database into your local. If you don’t have access to Acquia, you can download the dump database from this [linkk](https://drive.google.com/file/d/1mha-fwtKjb7931MFCEcAXVNOQt_IJ7Ce/view).
