...
if (file_exists('/var/www/site-php')) {
  require '/var/www/site-php/parentbuddy2/zimbabwe-settings.inc';
}
...
if (file_exists($app_root  . '/sites/default/settings.ddev.php') && getenv('IS_DDEV_PROJECT') == 'true') {
  ...
  $databases['default']['default']['database'] = 'zimbabwe_db';
}

$settings["config_sync_directory"] = '../config_zimbabwe/default';
