...
class TranslatorForm extends EntityForm {
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    if ($status === SAVED_UPDATED) {
      \Drupal::messenger()->addStatus($this->t('%label configuration has been updated.', array('%label' => $entity->label())));
    }
    else {
      \Drupal::messenger()->addStatus($this->t('%label configuration has been created.', array('%label' => $entity->label())));
    }
