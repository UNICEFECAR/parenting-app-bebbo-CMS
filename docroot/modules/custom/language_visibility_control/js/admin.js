        ...
        attach: function (context) {
            ...
            function createLanguageCheckbox(langcode, $fieldset) {
                ...
                if ($prototype.length) {
                    ...
                    var checkboxHtml = '<div class="js-form-item form-item js-form-type-checkbox form-type--checkbox form-type--boolean form-item-language-visibility-' + langcode + ' language-visibility-new">' +
