jQuery(document).ready(function() {
  ...
  jQuery( "<p>Recommend to select 10-15 content for best performance.</p>" ).insertAfter("#views-form-country-content-listing-page-5 .tableresponsive-toggle-columns");
});
