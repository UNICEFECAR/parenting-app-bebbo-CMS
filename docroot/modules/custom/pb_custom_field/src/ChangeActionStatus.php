 ...
 */
class ChangeActionStatus {

  /**
   * Processes each required or optional tag.
   */
  public static function offLoadCountryProcessfordraft($n_language, &$context) {
    ...
    foreach ($n_language as $key => $langs) {
      ...
      if($current_state !== 'draft' && empty($grps)){
        ...
        $node_lang_draft->revision_log = 'Content Changed Into draft';
