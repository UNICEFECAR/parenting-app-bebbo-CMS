 ...
 */
class ChangeintoSMEActionStatus {

  /**
   * Processes each required or optional tag.
   */
  public static function smereview($n_language, $all_nids, &$context) {
    ...
    foreach ($n_language as $key => $langs) {
      ...
      if($current_state !== 'sme_review' && empty($grps)){
        ...
        $msg = "Selected Content Is Allready In SME Review State";
        drupal_set_message(t($msg), 'error');
   ...
   * Processes each required or optional tag.
   */
  public static function smereviewyProcessFinishedCallback($success, $results, $operations) {
