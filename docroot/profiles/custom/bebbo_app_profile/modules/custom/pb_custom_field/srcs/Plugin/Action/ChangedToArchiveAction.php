 ...
 * )
 */ 
class ChangedToArchiveAction extends ViewsBulkOperationsActionBase {
...
// exit();
    ...
    if ($aaa == 1 && $page == 0) {
      ...
      'operations' => [
      [
        '\Drupal\pb_custom_field\ChangeintoArchiveActionStatus::offLoadCountryProcessd',
        [$n_language,$all_nids]
      ],
      ],
      'finished' => '\Drupal\pb_custom_field\ChangeintoArchiveActionStatus::offLoadsCountryProcessFinishedCallback',
    ];
    batch_set($batch);  
      }
