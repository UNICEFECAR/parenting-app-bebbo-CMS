  ...
  public function execute(ContentEntityInterface $entity = NULL) {
   $uid = \Drupal::currentUser()->id();
    ...
    if ($aaa == 1 && $page == 0) {
      ...
      'operations' => [
      [
        '\Drupal\pb_custom_field\ChangeintoSeniorEditorActionStatus::senioreditorstatusProcessd',
        [$n_language]
      ],
      ],
      'finished' => '\Drupal\pb_custom_field\ChangeintoSeniorEditorActionStatus::senioreditorstatusProcessdFinishedCallback',
    ];
    batch_set($batch);
}
