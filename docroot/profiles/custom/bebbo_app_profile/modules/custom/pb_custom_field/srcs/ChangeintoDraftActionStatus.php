 ...
 */
class ChangeintoDraftActionStatus {

  /**
   * Processes each required or optional tag.
   */
  public static function changeintodraftProcessd($n_language, $all_nids, &$context) {
   ...
   * Processes each required or optional tag.
   */
  public static function changeintodraftProcessdFinishedCallback($success, $results, $operations) {
